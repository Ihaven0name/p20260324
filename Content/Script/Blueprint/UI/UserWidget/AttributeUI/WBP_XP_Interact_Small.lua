...
function M:AfterNativeOnActivated()
    ...
    self.OwnedNumber=InventoryManager:GetItemQuantity(self.WBP_XP_Small.ItemTag)
...
function M:AfterSetWidgetController()
    ...
    self.WBP_XP_Small.Button.OnClicked:Add(self,self.OnClicked_Button_Add)
end
...
function M:ModifyOwnedNumber(ItemTag,ItemQuantity)
    if self.WBP_XP_Small.ItemTag == ItemTag then
